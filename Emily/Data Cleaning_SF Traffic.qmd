...
```{r}
#Define url of data
url <- 'C:\\Emily\\DSRP\\DSRP_2024\\DSRP-2024-Kaizheng\\Project_Code\\Data\\data_traffic.csv'

#alternate url: url <- 'https://raw.githubusercontent.com/the-codingschool/DSRP-2024-Kaizheng/Aditya-Das-Dev/Project_Code/Data/data_traffic.csv'
...
#move_pre_acc column has both 'Crossed Into Opposing Lane' + 'Crossing Into Opposing Lane'
clean_traffic_data[clean_traffic_data == 'Crossed Into Opposing Lane'] <- 'Crossed/Crossing Into Opposing Lane'
clean_traffic_data[clean_traffic_data == 'Crossing Into Opposing Lane'] <- 'Crossed/Crossing Into Opposing Lane'
