...
#change Vehicle/Pedestrian into Hit Pedestrian
clean_traffic_data$type_of_collision[clean_traffic_data$type_of_collision == 'Vehicle/Pedestrian'] <- 'Hit Pedestrian'

```

```{r}
#Adding casualty column to represent total number killed + injured
