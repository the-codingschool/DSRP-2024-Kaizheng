...
clean_traffic_data <- read_csv(url) print(clean_traffic_data)
```
...
#Merge 'Entering Traffic' and 'Changing Lanes' Into 'Merging/Changing Lanes' 
clean_traffic_data$move_pre_acc_merge[clean_traffic_data$move_pre_acc_merge == 'Entering Traffic'] <- 'Merging/Changing Lanes'
clean_traffic_data$move_pre_acc_merge[clean_traffic_data$move_pre_acc_merge == 'Changing Lanes'] <- 'Merging/Changing Lanes'
clean_traffic_data$move_pre_acc_merge[clean_traffic_data$move_pre_acc_merge == 'Merging'] <- 'Merging/Changing Lanes'  

#Merge 'Parked' and 'Stopped' into 'Stopped/Parked' 
clean_traffic_data$move_pre_acc_merge[clean_traffic_data$move_pre_acc_merge == 'Parked'] <- 'Stopped/Parked' 
clean_traffic_data$move_pre_acc_merge[clean_traffic_data$move_pre_acc_merge == 'Stopped'] <- 'Stopped/Parked'  

#Merge 'Other Unsafe Turning' and 'Ran Off Road' into 'Unsafe Behavior'
clean_traffic_data$move_pre_acc_merge[clean_traffic_data$move_pre_acc_merge == 'Ran Off Road'] <- 'Unsafe Behavior'
clean_traffic_data$move_pre_acc_merge[clean_traffic_data$move_pre_acc_merge == 'Other Unsafe Turning'] <- 'Unsafe Behavior'
clean_traffic_data$move_pre_acc_merge[clean_traffic_data$move_pre_acc_merge == 'Crossed Into Opposing Lane'] <- 'Unsafe Behavior'
clean_traffic_data$move_pre_acc_merge[clean_traffic_data$move_pre_acc_merge == 'Crossing Into Opposing Lane'] <- 'Unsafe Behavior'
clean_traffic_data$move_pre_acc_merge[clean_traffic_data$move_pre_acc_merge == 'Traveling Wrong Way'] <- 'Unsafe Behavior' 
```
