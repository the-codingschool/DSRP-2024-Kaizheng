...
CHIS_fatality <- lapply(accident_information_changed[,-c(5, 12, 13, 23)], function(x) chisq.test(table(factor(accident_information_changed[,23]), factor(x))))
...
accident_information_changed <- select(accident_information_changed, -inattention)
...
#Not an improvement
accident_information_changed <- select(accident_information_changed, -time_cat)

#Not an improvement - but taking out
accident_information_changed <- select(accident_information_changed, -weather_1)

#Slight improvement
accident_information_changed <- select(accident_information_changed, -month)

#HUGE improvement
accident_information_changed <- select(accident_information_changed, -party_age)

#No change really - taking out anyways
accident_information_changed <- select(accident_information_changed, -road_cond_1)

#Improvement
accident_information_changed <- select(accident_information_changed, -party_sex)

#Slight improvement
accident_information_changed <- select(accident_information_changed, -road_surface)

#Improvement
accident_information_changed <- select(accident_information_changed, -race)

#Did not help
#accident_information_changed <- select(accident_information_changed, -intersection)

#Huge improvement
accident_information_changed <- select(accident_information_changed, -distance)

#Improvement but doesn't make sense to take out
#accident_information_changed <- select(accident_information_changed, -party_sobriety)

#Slight improvement
accident_information_changed <- select(accident_information_changed, -vehicle_autonomous)

#No change
accident_information_changed <- select(accident_information_changed, -ped_action)

#Improved more
accident_information_changed <- select(accident_information_changed, -type_of_collision)


#accident_information_changed <- select(accident_information_changed, -party_type)

accident_information_changed <- select(accident_information_changed, -stwd_vehicle_type)
...
accident_information_changed <- select(accident_information_changed,-c(day_of_week, lighting, intersection, party_sobriety, party_type))
